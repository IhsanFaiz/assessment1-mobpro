...
@Composable
fun KerucutContent(bangunRuang: BangunRuang){
    ...
    Column(
        ...
        if (hasilBangunRuang?.volume != null){
            ...
            Box(
                ...
                Icon(
                    painter = painterResource(R.drawable.kerucut),
                    contentDescription = stringResource(R.string.kerucut),
                ...
                Text(
                    ...
                    modifier = Modifier.padding(start = 180.dp, bottom = 50.dp).rotate(60f),
                    style = MaterialTheme.typography.bodyLarge,
            ...
            ShareButton(R.drawable.kerucut, stringResource(R.string.kerucut), message)
        }
    }
}